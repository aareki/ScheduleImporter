...
public class WorkflowConfiguration  implements java.io.Serializable {
    ...
    private com.hannonhill.www.ws.ns.AssetOperationService.WorkflowStepConfigurations workflowStepConfigurations;
    ...
    public WorkflowConfiguration(
           ...
           com.hannonhill.www.ws.ns.AssetOperationService.WorkflowStepConfigurations workflowStepConfigurations) {
     ...
     */
    public com.hannonhill.www.ws.ns.AssetOperationService.WorkflowStepConfigurations getWorkflowStepConfigurations() {
        return workflowStepConfigurations;
    }
     ...
     */
    public void setWorkflowStepConfigurations(com.hannonhill.www.ws.ns.AssetOperationService.WorkflowStepConfigurations workflowStepConfigurations) {
        this.workflowStepConfigurations = workflowStepConfigurations;
    }
        ...
        _equals = true && 
            ...
            ((this.workflowStepConfigurations==null && other.getWorkflowStepConfigurations()==null) || 
             (this.workflowStepConfigurations!=null &&
              this.workflowStepConfigurations.equals(other.getWorkflowStepConfigurations())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getWorkflowStepConfigurations() != null) {
            _hashCode += getWorkflowStepConfigurations().hashCode();
        }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "workflow-step-configurations"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
