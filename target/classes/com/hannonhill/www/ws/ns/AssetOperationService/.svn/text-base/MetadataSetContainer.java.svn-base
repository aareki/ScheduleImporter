...
public class MetadataSetContainer  extends com.hannonhill.www.ws.ns.AssetOperationService.ContaineredAsset  implements java.io.Serializable {
    ...
    /**
     * Gets the children value for this MetadataSetContainer.
     * 
     * @return children
     */
    ...
    /**
     * Sets the children value for this MetadataSetContainer.
     * 
     * @param children
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MetadataSetContainer)) return false;
        MetadataSetContainer other = (MetadataSetContainer) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MetadataSetContainer.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "metadataSetContainer"));
