...
public class MetadataSet  extends com.hannonhill.www.ws.ns.AssetOperationService.ContaineredAsset  implements java.io.Serializable {
    ...
    private com.hannonhill.www.ws.ns.AssetOperationService.DynamicMetadataFieldDefinitions dynamicMetadataFieldDefinitions;
    ...
    public MetadataSet(
           ...
           com.hannonhill.www.ws.ns.AssetOperationService.DynamicMetadataFieldDefinitions dynamicMetadataFieldDefinitions) {
        super(
            id,
            entityType,
            name,
     ...
     */
    public com.hannonhill.www.ws.ns.AssetOperationService.DynamicMetadataFieldDefinitions getDynamicMetadataFieldDefinitions() {
        return dynamicMetadataFieldDefinitions;
    }
     ...
     */
    public void setDynamicMetadataFieldDefinitions(com.hannonhill.www.ws.ns.AssetOperationService.DynamicMetadataFieldDefinitions dynamicMetadataFieldDefinitions) {
        this.dynamicMetadataFieldDefinitions = dynamicMetadataFieldDefinitions;
    }
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.dynamicMetadataFieldDefinitions==null && other.getDynamicMetadataFieldDefinitions()==null) || 
             (this.dynamicMetadataFieldDefinitions!=null &&
              this.dynamicMetadataFieldDefinitions.equals(other.getDynamicMetadataFieldDefinitions())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getDynamicMetadataFieldDefinitions() != null) {
            _hashCode += getDynamicMetadataFieldDefinitions().hashCode();
        }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "dynamic-metadata-field-definitions"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
