/**
 * WorkflowDefinitionContainer.java
 *
...
public class WorkflowDefinitionContainer  extends com.hannonhill.www.ws.ns.AssetOperationService.ContaineredAsset  implements java.io.Serializable {
    ...
    /**
     * Gets the children value for this WorkflowDefinitionContainer.
     * 
     * @return children
     */
    ...
    /**
     * Sets the children value for this WorkflowDefinitionContainer.
     * 
     * @param children
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WorkflowDefinitionContainer)) return false;
        WorkflowDefinitionContainer other = (WorkflowDefinitionContainer) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(WorkflowDefinitionContainer.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "workflowDefinitionContainer"));
