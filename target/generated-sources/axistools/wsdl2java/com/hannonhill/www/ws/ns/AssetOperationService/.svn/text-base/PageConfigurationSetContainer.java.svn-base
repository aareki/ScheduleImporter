/**
 * PageConfigurationSetContainer.java
 *
...
public class PageConfigurationSetContainer  extends com.hannonhill.www.ws.ns.AssetOperationService.ContaineredAsset  implements java.io.Serializable {
    ...
    /**
     * Gets the children value for this PageConfigurationSetContainer.
     * 
     * @return children
     */
    ...
    /**
     * Sets the children value for this PageConfigurationSetContainer.
     * 
     * @param children
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PageConfigurationSetContainer)) return false;
        PageConfigurationSetContainer other = (PageConfigurationSetContainer) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PageConfigurationSetContainer.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "pageConfigurationSetContainer"));
