...
public class StructuredData  implements java.io.Serializable {
    ...
    private com.hannonhill.www.ws.ns.AssetOperationService.StructuredDataNodes structuredDataNodes;
    ...
    public StructuredData(
           ...
           com.hannonhill.www.ws.ns.AssetOperationService.StructuredDataNodes structuredDataNodes) {
     ...
     */
    public com.hannonhill.www.ws.ns.AssetOperationService.StructuredDataNodes getStructuredDataNodes() {
        return structuredDataNodes;
    }
     ...
     */
    public void setStructuredDataNodes(com.hannonhill.www.ws.ns.AssetOperationService.StructuredDataNodes structuredDataNodes) {
        this.structuredDataNodes = structuredDataNodes;
    }
        ...
        _equals = true && 
            ...
            ((this.structuredDataNodes==null && other.getStructuredDataNodes()==null) || 
             (this.structuredDataNodes!=null &&
              this.structuredDataNodes.equals(other.getStructuredDataNodes())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getStructuredDataNodes() != null) {
            _hashCode += getStructuredDataNodes().hashCode();
        }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "structured-data-nodes"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
