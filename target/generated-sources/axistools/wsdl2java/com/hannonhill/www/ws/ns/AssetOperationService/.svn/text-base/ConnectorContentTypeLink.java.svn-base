...
public class ConnectorContentTypeLink  implements java.io.Serializable {
    ...
    private com.hannonhill.www.ws.ns.AssetOperationService.ConnectorContentTypeLinkParamList connectorContentTypeLinkParams;
    ...
    public ConnectorContentTypeLink(
           ...
           com.hannonhill.www.ws.ns.AssetOperationService.ConnectorContentTypeLinkParamList connectorContentTypeLinkParams) {
     ...
     */
    public com.hannonhill.www.ws.ns.AssetOperationService.ConnectorContentTypeLinkParamList getConnectorContentTypeLinkParams() {
        return connectorContentTypeLinkParams;
    }
     ...
     */
    public void setConnectorContentTypeLinkParams(com.hannonhill.www.ws.ns.AssetOperationService.ConnectorContentTypeLinkParamList connectorContentTypeLinkParams) {
        this.connectorContentTypeLinkParams = connectorContentTypeLinkParams;
    }
        ...
        _equals = true && 
            ...
            ((this.connectorContentTypeLinkParams==null && other.getConnectorContentTypeLinkParams()==null) || 
             (this.connectorContentTypeLinkParams!=null &&
              this.connectorContentTypeLinkParams.equals(other.getConnectorContentTypeLinkParams())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getConnectorContentTypeLinkParams() != null) {
            _hashCode += getConnectorContentTypeLinkParams().hashCode();
        }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "connector-content-type-link-param-list"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
