...
public class DynamicMetadataField  implements java.io.Serializable {
    ...
    private com.hannonhill.www.ws.ns.AssetOperationService.FieldValues fieldValues;
    ...
    public DynamicMetadataField(
           ...
           com.hannonhill.www.ws.ns.AssetOperationService.FieldValues fieldValues) {
           this.name = name;
     ...
     * @return fieldValues
     */
    public com.hannonhill.www.ws.ns.AssetOperationService.FieldValues getFieldValues() {
        return fieldValues;
    }
     ...
     * @param fieldValues
     */
    public void setFieldValues(com.hannonhill.www.ws.ns.AssetOperationService.FieldValues fieldValues) {
        this.fieldValues = fieldValues;
    }
        ...
        _equals = true && 
            ...
            ((this.fieldValues==null && other.getFieldValues()==null) || 
             (this.fieldValues!=null &&
              this.fieldValues.equals(other.getFieldValues())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getFieldValues() != null) {
            _hashCode += getFieldValues().hashCode();
        }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "fieldValues"));
