...
public class ConnectorContainer  extends com.hannonhill.www.ws.ns.AssetOperationService.ContaineredAsset  implements java.io.Serializable {
    ...
    /**
     * Gets the children value for this ConnectorContainer.
     * 
     * @return children
     */
    ...
    /**
     * Sets the children value for this ConnectorContainer.
     * 
     * @param children
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConnectorContainer)) return false;
        ConnectorContainer other = (ConnectorContainer) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConnectorContainer.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "connectorContainer"));
