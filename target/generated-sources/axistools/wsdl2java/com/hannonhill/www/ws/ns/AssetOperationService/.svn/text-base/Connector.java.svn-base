...
public class Connector  extends com.hannonhill.www.ws.ns.AssetOperationService.ContaineredAsset  implements java.io.Serializable {
    ...
    private com.hannonhill.www.ws.ns.AssetOperationService.ConnectorParameterList connectorParameters;

    private com.hannonhill.www.ws.ns.AssetOperationService.ConnectorContentTypeLinkList connectorContentTypeLinks;
    ...
    public Connector(
           ...
           com.hannonhill.www.ws.ns.AssetOperationService.ConnectorParameterList connectorParameters,
           com.hannonhill.www.ws.ns.AssetOperationService.ConnectorContentTypeLinkList connectorContentTypeLinks) {
        super(
            id,
            entityType,
            name,
     ...
     */
    public com.hannonhill.www.ws.ns.AssetOperationService.ConnectorParameterList getConnectorParameters() {
        return connectorParameters;
    }
     ...
     */
    public void setConnectorParameters(com.hannonhill.www.ws.ns.AssetOperationService.ConnectorParameterList connectorParameters) {
        this.connectorParameters = connectorParameters;
    }
     ...
     */
    public com.hannonhill.www.ws.ns.AssetOperationService.ConnectorContentTypeLinkList getConnectorContentTypeLinks() {
        return connectorContentTypeLinks;
    }
     ...
     */
    public void setConnectorContentTypeLinks(com.hannonhill.www.ws.ns.AssetOperationService.ConnectorContentTypeLinkList connectorContentTypeLinks) {
        this.connectorContentTypeLinks = connectorContentTypeLinks;
    }
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.connectorParameters==null && other.getConnectorParameters()==null) || 
             (this.connectorParameters!=null &&
              this.connectorParameters.equals(other.getConnectorParameters()))) &&
            ((this.connectorContentTypeLinks==null && other.getConnectorContentTypeLinks()==null) || 
             (this.connectorContentTypeLinks!=null &&
              this.connectorContentTypeLinks.equals(other.getConnectorContentTypeLinks())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getConnectorParameters() != null) {
            _hashCode += getConnectorParameters().hashCode();
        }
        if (getConnectorContentTypeLinks() != null) {
            _hashCode += getConnectorContentTypeLinks().hashCode();
        }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "connector-parameter-list"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "connector-content-type-link-list"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
