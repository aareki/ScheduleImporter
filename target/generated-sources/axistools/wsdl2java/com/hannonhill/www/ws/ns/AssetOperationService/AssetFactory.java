...
public class AssetFactory  extends com.hannonhill.www.ws.ns.AssetOperationService.ContaineredAsset  implements java.io.Serializable {
    ...
    private com.hannonhill.www.ws.ns.AssetOperationService.AssetFactoryPlugins plugins;
    ...
    public AssetFactory(
           ...
           com.hannonhill.www.ws.ns.AssetOperationService.AssetFactoryPlugins plugins) {
        super(
            id,
            entityType,
            name,
     ...
     * @return plugins
     */
    public com.hannonhill.www.ws.ns.AssetOperationService.AssetFactoryPlugins getPlugins() {
        return plugins;
    }
     ...
     * @param plugins
     */
    public void setPlugins(com.hannonhill.www.ws.ns.AssetOperationService.AssetFactoryPlugins plugins) {
        this.plugins = plugins;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "asset-factory-plugins"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
