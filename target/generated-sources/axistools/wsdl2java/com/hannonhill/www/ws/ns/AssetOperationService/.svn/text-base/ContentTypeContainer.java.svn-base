...
public class ContentTypeContainer  extends com.hannonhill.www.ws.ns.AssetOperationService.ContaineredAsset  implements java.io.Serializable {
    private com.hannonhill.www.ws.ns.AssetOperationService.ContainerChildren children;

    public ContentTypeContainer() {
    }
    ...
    /**
     * Gets the children value for this ContentTypeContainer.
     * 
     * @return children
     */
    ...
    /**
     * Sets the children value for this ContentTypeContainer.
     * 
     * @param children
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ContentTypeContainer)) return false;
        ContentTypeContainer other = (ContentTypeContainer) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ContentTypeContainer.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "contentTypeContainer"));
