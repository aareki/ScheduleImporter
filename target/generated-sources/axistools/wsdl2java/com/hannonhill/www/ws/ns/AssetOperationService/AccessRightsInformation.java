...
public class AccessRightsInformation  implements java.io.Serializable {
    ...
    private com.hannonhill.www.ws.ns.AssetOperationService.AclEntries aclEntries;
    ...
    public AccessRightsInformation(
           ...
           com.hannonhill.www.ws.ns.AssetOperationService.AclEntries aclEntries,
     ...
     * @return aclEntries
     */
    public com.hannonhill.www.ws.ns.AssetOperationService.AclEntries getAclEntries() {
        return aclEntries;
    }
     ...
     * @param aclEntries
     */
    public void setAclEntries(com.hannonhill.www.ws.ns.AssetOperationService.AclEntries aclEntries) {
        this.aclEntries = aclEntries;
    }
        ...
        _equals = true && 
            ...
            ((this.aclEntries==null && other.getAclEntries()==null) || 
             (this.aclEntries!=null &&
              this.aclEntries.equals(other.getAclEntries()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getAclEntries() != null) {
            _hashCode += getAclEntries().hashCode();
        }
        if (getAllLevel() != null) {
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "acl-entries"));
