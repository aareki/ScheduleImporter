...
public class Template  extends com.hannonhill.www.ws.ns.AssetOperationService.FolderContainedAsset  implements java.io.Serializable {
    ...
    private com.hannonhill.www.ws.ns.AssetOperationService.PageRegions pageRegions;
    ...
    public Template(
           ...
           com.hannonhill.www.ws.ns.AssetOperationService.PageRegions pageRegions) {
        super(
            id,
            entityType,
            name,
     ...
     * @return pageRegions
     */
    public com.hannonhill.www.ws.ns.AssetOperationService.PageRegions getPageRegions() {
        return pageRegions;
    }
     ...
     * @param pageRegions
     */
    public void setPageRegions(com.hannonhill.www.ws.ns.AssetOperationService.PageRegions pageRegions) {
        this.pageRegions = pageRegions;
    }
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.pageRegions==null && other.getPageRegions()==null) || 
             (this.pageRegions!=null &&
              this.pageRegions.equals(other.getPageRegions())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getPageRegions() != null) {
            _hashCode += getPageRegions().hashCode();
        }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "page-regions"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
