...
public class WorkflowStep  implements java.io.Serializable {
    ...
    private com.hannonhill.www.ws.ns.AssetOperationService.WorkflowActions actions;
    ...
    public WorkflowStep(
           ...
           com.hannonhill.www.ws.ns.AssetOperationService.WorkflowActions actions) {
     ...
     * @return actions
     */
    public com.hannonhill.www.ws.ns.AssetOperationService.WorkflowActions getActions() {
        return actions;
    }
     ...
     * @param actions
     */
    public void setActions(com.hannonhill.www.ws.ns.AssetOperationService.WorkflowActions actions) {
        this.actions = actions;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.hannonhill.com/ws/ns/AssetOperationService", "workflowActions"));
